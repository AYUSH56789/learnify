...
const navigate = useNavigate();
  ...
  return (
    <div className="relative bg-[url('/hero.jpg')] bg-no-repeat bg-cover dark:bg-[url('/img/hero-pattern-dark.svg')] dark:bg-no-repeat dark:bg-cover py-48 px-4 text-center">
